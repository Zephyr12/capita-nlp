...
if __name__ == "__main__":
    ...
    #db.create_table("schools", {"id": "int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY", "URN": "integer NOT NULL", "establishment_name": "text NOT NULL", "postcode": "text", "type_of_establishment": "text", "phase_of_education": "text" })
