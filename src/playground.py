...
# Each page has 'category','name','id'
    ...
    try:
        print('PAGE #', p, '(' + str(len(r[u'data'])) + ')', page[u'name'], page[u'category'], page[u'id'],
...
#          print
        ...
        if not commentsPageSkip:
          if v:
            print('# COMMENTS PAGES', nPages, '# POSTS', nPosts, '# MATCHES', nMatches,
                  strftime("%H:%M:%S", time.localtime()), end=' ')
